class CfgPatches
{
    class ld3k_jca_hk433_compat_ace3
    {
        requiredAddons[]=
        {
            "Weapons_F_JCA_HK433",
...
class CfgAmmo
{
    ...
    class JCA_B_556x45_Ball: BulletBase // M855, ACE3 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L117
    {
        ...
        waterFriction=-0.3;
        caliber=0.869565; // B_556x45_Ball, M995 AP3 52gr: 12mm RHA 100m MV 1030m/s https://www.nammo.com/, perforation in-game 12mm RHA "armour_plate_12mm.bisurf" 100m ~900m/s ICAO: caliber ~0.9
        // M855: 1020 steel plate (Hardness=50/70 Rb; thickness=3mm) 570m (MV 910m/s), perforation in-game 3mm RHA "armour_plate_3mm.bisurf" 570m ~400m/s ICAO: caliber ~0.55
    ...
    class JCA_B_556x45_Ball_M995AP: JCA_B_556x45_Ball // ACE_556x45_Ball_M995_AP https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L168
    {
        ...
        // M995 AP4 69gr: 7mm RHA 200m MV 900m/s https://www.nammo.com/, perforation in-game 7mm RHA "armour_plate_7mm.bisurf" 200m ~700m/s ICAO: caliber ~0.7
        // M995 AP3 52gr: 12mm RHA 100m MV 1030m/s https://www.nammo.com/, perforation in-game 12mm RHA "armour_plate_12mm.bisurf" 100m ~900m/s ICAO: caliber ~0.9
    };
...
class CfgMagazines
{
    ...
    {
        picture="\weapons_f_JCA_HK433\MagazineProxies\data\UI\Icon_30Rnd_556x45_SMAG_CA.paa";
        author="Grave";
        scope=2;
        ...
        modelSpecial="weapons_f_JCA_HK433\MagazineProxies\30Rnd_556_SMAG.p3d";
        modelSpecialIsProxy=1;
    };
    ...
    class JCA_30Rnd_556x45_Stanag_Sand: JCA_30Rnd_556x45_Stanag
    {
        ...
        picture="\weapons_f_JCA_HK433\MagazineProxies\data\UI\Icon_30Rnd_556x45_SMAG_sand_CA.paa";
        hiddenSelections[]=
        {
            "Camo"
        };
        ...
        {
            "weapons_f_JCA_HK433\MagazineProxies\data\mag_30Rnd_556_SMAG_sand_CO.paa"
        };
    };
